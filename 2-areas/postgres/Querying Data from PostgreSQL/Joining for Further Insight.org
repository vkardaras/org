...
:PROPERTIES:
:CUSTOM_ID: alternative-inner-join-syntax
:END:
#+begin_src sql
        FROM customers
INNER JOIN orders
...
** Implementing Joins
:PROPERTIES:
:CUSTOM_ID: implementing-joins
:END:
*** Lookup tables
:PROPERTIES:
:CUSTOM_ID: lookup-tables
:END:
