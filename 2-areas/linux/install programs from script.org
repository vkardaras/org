...
pkgs=(networkmanager curl wget git tmux ttf-jetbrains-mono-nerd zsh wezterm starship thefuck eza fzf bat neovim neofetch ripgrep jdk21-openjdk nodejs npm maven jq kitty imagemagick zip unzip xclip lazygit ghostty zoxide fuse2 gcc pandoc dnsutils shellcheck tidy stylelint)
